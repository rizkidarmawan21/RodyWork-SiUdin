    ...
    while ($row=$hasil->fetch_assoc()){
        ...
        "<div class='rounded-lg shadow-lg max-w-3xl mb-10 bg-white mt-5 p-4 lg:mx-auto mx-5'>
            ...
            <div class='relative created-time mt-10 text-lg font-medium align-top'>
                <p class='absolute left-0 bottom-1'><span><i class='fa-regular fa-heart text-slate-700'></i>
                        10K</span><span class='ml-2'><i class='fa-solid fa-thumbs-down text-slate-700'></i>
                        1K</span></p>
            </div>
